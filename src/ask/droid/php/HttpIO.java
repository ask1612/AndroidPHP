 ...
 * It works as an asynchronous task, gets created     when the register
 * or login button is pressed.
 */
class HttpIO extends AsyncTask<String, String, String> {
     ...
     * gets an JSON object as a string,
     * closes the progress dialog, shows a  message from the http server,
